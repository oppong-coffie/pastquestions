        ...
        <div class="card-body">
          <form name="login-form" class="login-form" action="" method="POST">
            ...
            <div class="input-group form-group">
              ...
              <input name="email" type="text" class="form-control" placeholder="email" onkeyup="validate();" required>
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio quaerat earum dicta sit quos saepe in aspernatur ad architecto, accusantium eligendi aliquam omnis hic natus ut, facilis, ullam rem corrupti?
  </body>
</html>

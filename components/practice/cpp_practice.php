...
<div class="app-main__inner">
    ...
    <div class="">
        ...
        <div id="answer3" class="answeroff">
            ...
            <div class="text-slate-500"><span class="text-green-700 font-semibold">Explanation:</span>C++ uses double quotes to include a user-defined header file. The correct syntax of including user-defined is #include “userdefinedname”.
            </div>
        </div>
    </div>
    <div class="">

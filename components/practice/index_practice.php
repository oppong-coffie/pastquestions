...
<div class="app-main__inner">
                    ...
                    <div class="row main-content content-container">
                            ...
                            <div id="javaDiv" class="col-xl-3">
                                <a href="./index.php?page=layout_practice&page2=java">
                                <div class="mb-3 widget-content bg-midnight-bloom" id="cardjava">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading"><img style="width: 3vw" src="../images/java-logo.svg" alt=""></div>
                            ...
                            <div id="cppDiv" class="col-xl-3">
                                <a href="./index.php?page=layout_practice&page2=cpp">
                                <div class=" mb-3 widget-content bg-arielle-smile"  id="cardcpp">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading"><img style="width: 3vw" src="../images/cpp-logo.png" alt=""></div>
                            ...
                            <div id="pythonDiv" class="col-xl-3">
                                    <a href="./index.php?page=layout_practice&page2=python">
                                <div class=" mb-3 widget-content bg-grow-early" id="cardp">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading"><img style="width: 3vw" src="../images/python-logo.png" alt=""></div>

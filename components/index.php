...
$sql_personal = "SELECT * FROM students WHERE `email`='$useremail'";
$query_personal = mysqli_query($dbcon, $sql_personal);
$fetch_personal = mysqli_fetch_assoc($query_personal);
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                            ...
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="../images/hp.png"
                                                alt="">
                                ...
                                <div class="widget-content-left  ml-3 header-user-info">
                                    <div class="widget-heading">
                                        <?php echo $fetch_personal['fullName']; ?>
                                    </div>
        ...
        <?php
            ...
            if($page!="")
            {
                if($page=="layout_practice")
            {
                include('./practice/layout_practice.php');
            }
                if($page=="layout_access")
            {
                include('./Access/Access_Layout.php');
            }
            
            if($page=="layout_pastquestions")
            {
                include('./layout_pastquestions.php');
            }
            ...
            else
            {
                    ...
                    include('./index.pastquestions.php');
            }
        ?>

...
// sql
$sql = "SELECT * FROM access_practice_questions WHERE course_name='maths.obj'";
...
<div class="roww">
  <p class="text-xl font-bold text-center text-black">
    Mathematics MCQ (Multiple Choice Questions)
  </p>
  <p>
  <a href="./index.php?page=layout_access&page2=maths.b">

...
// sql
$sql = "SELECT * FROM access_practice_questions WHERE course_name='sci.b'";
...
<div class="roww">
  <p class="text-xl font-bold text-center text-black">
    Integrated Science  (Theory Questions)
  </p>
  <p>
    <a href="./index.php?page=layout_access&page2=science.obj">
        <button class="primary-button" type="button">Objective</button>
    </a>
</p>
</div>
